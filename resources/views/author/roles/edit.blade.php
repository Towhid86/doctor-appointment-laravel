    ...
    <div class="erp-table-section">
        <div class="container-fluid">
            <div class="table-header">
                ...
                <small class="text-warning">Set role permissions</small>
            </div>
            <div class="row justify-content-center mt-2 roles-permissions">
                <div class="col-md-12">
                    <form action="{{ route('author.roles.update', $role->id) }}" method="post"
                        ...
                        <div class="col-12">
                                                    ...
                                                    @foreach($group as $permission)
                                                        <div class="custom-control custom-checkbox mr-3 me-lg-5">
                                                            <input type="checkbox" name="permissions[]"
                                                                   ...
                                                                   id="id_{{ $permission->id }}" @checked($role->hasPermissionTo($permission->name))>
                            ...
                            <div class="col-12 text-center mt-2">
                                ...
                                <button type="submit"
                                        class="btn btn-warning btn-custom-warning fw-bold me-2 submit-btn"><i
