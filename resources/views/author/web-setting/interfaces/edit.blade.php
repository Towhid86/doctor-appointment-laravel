            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="table-header">
                        ...
                        <div>
                            <a href="{{ route('author.interfaces.index') }}" class="theme-btn print-btn text-light">
                    ...
                    <div class="order-form-section">
                        <form action="{{ route('author.interfaces.update', $interface->id) }}" method="post" enctype="multipart/form-data" class="ajaxform_instant_reload">
                            @csrf
                            @method('put')
