                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mt-2">
                                                    <div class="feature-row sample-form-wrp duplicate-feature">
                                                        <div class="">
                                                            <button type="button"
                                                                class="btn btn-secondary service-btn-possition feature-add-btn">{{ __('+') }}</button>
                                                            <button type="button"
                                                                class="btn text-danger remove-btn-features feature-remove-btn"
                                                        ...
                                                        <div class="row mb-4">
                                                            <div class="mt-2">
                                                                <label>{{ __('Tags') }}</label>
                                                                <input type="text" name="tags[]" value="{{ $tag ?? '' }}" class="form-control clear-input" placeholder="{{ __('Enter Tag') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 mb-2">
                                                        ...
                                                        <div class="row row-items">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input type="text" name="tags[]"
                                                                    value="{{ $tag ?? '' }}" class="form-control" required
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mt-2">
                                                        <a href="javascript:void(0)" class="fw-bold text-primary add-new-item"><i
                                                                class="fas fa-plus-circle"></i> Add new row</a>
                                                    </div>
                                                </div>
                                            </div>
