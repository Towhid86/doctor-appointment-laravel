            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="order-form-section">
                        <form action="{{ route('author.designs.store') }}" method="post" enctype="multipart/form-data" class="ajaxform_instant_reload">
                            @csrf
