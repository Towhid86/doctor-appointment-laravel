    ...
    <div class="erp-table-section">
        <div class="container-fluid">
            <div class="table-header">
                <h4>{{__('Tutorial List')}}</h4>
                @can('tutorials-create')
                    <a href="{{ route('author.tutorials.create') }}" class="add-order-btn rounded-2 {{ Route::is('author.tutorials.create') ? 'active' : '' }}"><i class="fas fa-plus-circle"></i> {{ __('Add New Tutorial') }}</a>
                @endcan
            </div>

            <div class="table-top-form daily-transaction-between-wrapper">
                <form class="searchForm" action="{{ route('author.tutorials.index') }}" method="get">
                    <div class="grid-3">
            ...
            <div class="responsive-table rounded-image">
                <table class="table" id="erp-table">
                    ...
                    @include('author.tutorials.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
                {{ $tutorials ->links('vendor.pagination.bootstrap-5') }}
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="personal-info">
                        <div class="row align-items-center mt-3">
                            <div class="col-md-4"><p>{{ __('tutorials Category') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-md-7"><p id="user_view_tutorials_category"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-md-5"><p>{{ __('Shop Name') }}</p></div>
                            <div class="col-md-7"><p id="user_view_tutorials_name"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
