            ...
            <div class="row">
                    ...
                    <div class="erp-dashboard-profile card">
                        ...
                        <div class="profile-img">
                            <img id="profile_picture"
                                 src="{{ asset(Auth::user()->image ?? 'assets/images/profile/profile-img.png') }}"
                                 alt="user avatar">
                        </div>
                        <div class="profile-details card-body">
                            <ul class="list-group">
                                <li class="list-group-item"><span>Name: </span>{{ ucwords($user->name) }}</li>
                                <li class="list-group-item"><span>Email: </span>{{ $user->email }}</li>
                                <li class="list-group-item">
                                    <span>Registration Date:</span> {{ formatted_date($user->created_at) }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="erp-dashboard-profile-section card">
                        ...
                        <form action="{{ route('author.profiles.update',$user->id) }}" method="post"
