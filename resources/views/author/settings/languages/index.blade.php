        ...
        <div class="container-fluid">
            <div class="table-header">
                ...
                @can('languages-create')
                    <a href="{{ route('author.language-settings.create') }}"
                       class="add-order-btn rounded-2 {{ Route::is('author.language-settings.create') ? 'active' : '' }}"><i
                            class="fas fa-plus-circle"></i> {{ __('Add New Language') }}</a>
                @endcan
            </div>

            <div class="table-top-form daily-transaction-between-wrapper">
                <form class="searchForm" action="{{ route('author.language-settings.index') }}" method="get">
                    <div class="grid-3">
            ...
            <div class="responsive-table rounded-image">
                <table class="table" id="erp-table">
                    ...
                    @include('author.settings.languages.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
                ...
                <div class="modal-body">
                    <div class="personal-info">
                        <div class="row align-items-center mt-3">
                            <div class="col-md-4"><p>{{ __('languages Category') }}</p></div>
                            <div class="col-1">
                                <p>:</p>
                            </div>
                            <div class="col-md-7"><p id="user_view_languages_category"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
                            <div class="col-md-5"><p>{{ __('Shop Name') }}</p></div>
                            <div class="col-md-7"><p id="user_view_languages_name"></p></div>
                        </div>
                        <div class="row align-items-center mt-3">
