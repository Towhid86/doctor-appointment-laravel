...
<div class="email-container">
    ...
    <div class="email-body">
        <p>{{ __('You are having this email because you have requested for a ').$data['subject'].'.' }}</p>
        <p>{{ __('Your OTP : ') }}<b>{{ $data['otp'] }} </b></p>


        <p>{{ __('Approved by Admin.') }}</p>
