...
class BaariWebsiteSettingController extends Controller
{
    public function index()
    {
        ...
        return view('author.pages.web-setting.index', compact('logo', 'general', 'landings', 'app_download', 'footer', 'pages', 'policy', 'term', 'faqs', 'histories', 'user_types'));
    }
